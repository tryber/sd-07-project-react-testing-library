...
describe('testing App.js functionality', () => {
  ...
  it('Should redirect to home (pathname: /) if clicks on homes link', () => {
  ...
  it('Should redirect to about (pathname: /about) if clicks on abouts link', () => {
    const { getByText, history } = renderWithRouter(<App />);
  ...
  it('Should redirect to favorite pokemons (pathname: /favorites) if clicks in favorites link', () => {
    const { getByText, history } = renderWithRouter(<App />);
